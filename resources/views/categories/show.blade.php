<x-layout :title="$pageTitle">
    <div class="group mb-4 p-4 flex flex-wrap gap-4 rounded-2xl text-white bg-gray-800 shadow-lg shadow-gray-800">
        ...
        <!-- But Blade does not parse variables inside single-quoted strings. 
         So 'category/{{ $category->id }}/posts' is literally the string 
         category/{{ $category->id }}/posts, not e.g. category/1/posts. -->
